...
configs = {
    ...
    'vxBeta': {'label': 'Planetary Vorticity Advection', 'vmin': -0.2e-9, 'vmax': 0.2e-9},
    'ZetaDivH': {'label': 'Stretching Term zeta', 'vmin': -2e-9, 'vmax': 2e-9},
    'fDivH': {'label': 'Stretching Term f', 'vmin': -1.5e-9, 'vmax': 1.5e-9},
    'Tilting': {'label': 'Tilting Term', 'vmin': -2e-9, 'vmax': 2e-9},
    'ResZ': {'label': 'Friction Residual', 'vmin': -2e-9, 'vmax': 2e-9},
    'tilt_advV': {'label': 'Tilting + Vertical Vorticity Advection', 'vmin': -2.5e-9, 'vmax': 2.5e-9}
}

# Datas de destaque
highlight_times = ['2024-10-04T00', '2024-10-05T00', '2024-10-06T00',
                    '2024-10-07T00', '2024-10-08T00', '2024-10-09T00', '2024-10-10T00']
