...
for nome_arquivo, caminho in arquivos.items():
    ...
    ax.set_ylim(200, 10)
    ax.set_yscale('log')
    ax.set_yticks([200, 100, 70, 50, 30, 20, 10])
    ax.set_yticklabels([200, 100, 70, 50, 30, 20, 10])
    ...
    # Salvar o gráfico
    plt.savefig(DIRFIGS + f"{nome_arquivo}_track_hov_custom_200_10.png", bbox_inches='tight', dpi=300)
    plt.close()
