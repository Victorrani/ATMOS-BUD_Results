...
configs = {
    'dTdt': {'label': 'Local Temperature Tendency', 'vmin': -0.25, 'vmax': 0.5},
    'AdvHTemp': {'label': 'Horizontal Temperature Advection', 'vmin': -2, 'vmax': 2},
    'AdvVTemp': {'label': 'Vertical Temperature Advection', 'vmin': -2, 'vmax': 2},
    'Sigma_omega': {'label': 'Total Vertical Motion Effect', 'vmin': -15, 'vmax': 5},
    'ResT': {'label': 'Diabatic Heating', 'vmin': -1, 'vmax': 1}
}
