...
fig.legend(labels, loc='lower center', bbox_to_anchor=(0.5, -0.07), fontsize=18, ncol=4, frameon=True)

# Ajustar espaçamento entre os subplots
fig.tight_layout(rect=[0, 0, 1, 0.92])

# Adicionar um título geral
fig.suptitle('Vorticity Budget Analysis', fontsize=20, fontweight='bold', y=0.95)

# Salvar a figura
plt.savefig(DIRFIGS + 'Vorticity_Budget_Combined_2x2.png', bbox_inches='tight', dpi=300)
plt.close()

print("Gráfico 2x2 combinado gerado com sucesso!")
