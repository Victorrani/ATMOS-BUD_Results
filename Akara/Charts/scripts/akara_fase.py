...
ax1.legend(loc='lower right', bbox_to_anchor=(1, 0))  # Ajuste da posição da legenda do eixo 1
...
ax2.legend(loc='lower right', bbox_to_anchor=(1, 0.06))  # Ajuste da posição da legenda
