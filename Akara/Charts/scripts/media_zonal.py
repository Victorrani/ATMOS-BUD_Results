...
DIRFIG = '/home/victor/USP/sinotica3/ATMOS-BUD_Results/Akara/Charts/cross_sections/zonal_deviation_theta/'
...
for i in range(len(df)):
    ...
    theta_zonal_devation = cross['Potential_temperature'] - cross_theta_mean
    ...
    contour = ax.contourf(
    cross["longitude"], cross["pressure_level"], theta_zonal_devation,
    levels=np.arange(-1, 1, 0.2), cmap=plt.get_cmap("coolwarm"), extend='both'
)
...
# Adicionando a barra de cores
    ...
    plt.savefig(f"{DIRFIG}Akara_cross_zonal_deviation{time}.png", dpi=300)
