...
import matplotlib.dates as mdates  # Importação correta do módulo 'dates'
...
for i in range(0,len(df),2):
    ...
    mean_temp_grande = temp_box_grande.mean(dim=['latitude', 'longitude']).values
...
# Salvando a imagem
plt.savefig(DIRFIG+'hov_reboita_suave.png', dpi=300)